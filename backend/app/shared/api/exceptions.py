...
class ExternalServiceTimeoutError(ExternalServiceError):
    def __init__(self, message: str = "External service timeout", details: Optional[Any] = None):
        super().__init__(message=message, code="EXTERNAL_SERVICE_TIMEOUT", status_code=504, details=details)
