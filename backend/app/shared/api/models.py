...
class APIError(BaseCamelModel):
    ...
    """
    code: str = Field(description="A machine-readable error code (e.g., 'VALIDATION_ERROR')")
    message: str = Field(description="A human-readable error message")
    details: Optional[Any] = Field(default=None, description="Optional structured details about the error")
