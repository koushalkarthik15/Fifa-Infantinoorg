...
from app.features.crowd.schemas.crowd import (
    HeatmapResponse, DensityNodeDTO, PredictionRequest, PredictionResponse,
    RouteRequest, RouteResponse, RouteSegmentDTO
)
from app.features.crowd.prompts.crowd import CROWD_PREDICTION_PROMPT_TEMPLATE, ROUTE_AUGMENTATION_PROMPT_TEMPLATE
    ...
    async def get_prediction(self, request: PredictionRequest) -> PredictionResponse:
        ...
        try:
            ...
            return PredictionResponse(
                prediction_text=result.get("prediction_text", "Prediction unavailable."),
