...
from app.features.sustainability.schemas.sustainability import (
    GreenRouteRequest, GreenRouteResponse, RouteSegmentDTO,
...
class SustainabilityService:
    ...
    async def get_green_route(self, request: GreenRouteRequest) -> GreenRouteResponse:
        try:
            ...
            segments = [{"instruction": f"Head towards {request.destination}", "distance_meters": 500, "duration_seconds": 300}]
            total_duration = 300
        ...
        try:
            ...
            recommendation = result.get("recommendation", "Thank you for choosing green transportation!")
        except Exception as e:
