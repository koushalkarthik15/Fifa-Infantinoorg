...
from app.features.accessibility.services.accessibility_service import AccessibilityService
from app.features.accessibility.schemas.accessibility import (
    AssistantRequest, AssistantResponse,
    AccessibleRouteRequest, AccessibleRouteResponse,
...
async def get_assistant(
    ...
    return APIResponse(success=True, message="Assistant response generated.", data=result)
